<html>
	<Title>OnTip File browser Boulamis</title>
	<head>
  ...
  if ($handle = @opendir($dir)) 
    {
       while (false !== ($file = @readdir($handle))) { 
        ...
        if (strlen($file) > 3 ){    
          ...
          echo "<tr><td>".$j.". </td><td><center><a href = '".$bestand."' target = '_blank'>open</a></center></td><td>".$dir."</td><td>".$file."</td><td style='text-align:right;'>".$filesize."</td><td style='text-align:right;'>".date("Y-m-d h:i", $last_mod)."</td></tr>";       
          $j++;
         }
