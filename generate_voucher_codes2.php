...
////
////  Programma voor het aanmaken van een csv bestand met 100 unieke voucher codes voor een toernooi. Dit csv bestand wordt verstuurd via email.
...
<FORM action='generate_voucher_codes2.php?toernooi=<?php echo $toernooi;?>' method='post'>
