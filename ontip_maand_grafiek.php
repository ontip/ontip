...
<title>OnTip Statistieken inschrijvingen</title>
<link rel="shortcut icon" type="image/x-icon" href="images/OnTip_banner.ico">
<style type="text/css"> 
...
fwrite($fp, "<chart_rect x='100' y='80'   />\n");
...
fwrite($fp, "	<draw>\n");
fwrite($fp, "   <text x='80' y='0' height='100' color ='FF4400' margin='55' size= '14'>Deelnemers aan OnTip toernooien per maand</text>\rn\rn\rn");
fwrite($fp, "	</draw>\n");
fwrite($fp, "\r\n");
fwrite($fp, "\r\n");
fwrite($fp, "\n");
...
fwrite($fp, "  </series_color>"."\n");
*/
fwrite($fp, "  <series bar_gap='30' set_gap='20' />"."\n");
...
<table STYLE ='background-color:white;' width=99% border = 0>
<tr><td rowspan=3><img src = '../ontip/images/ontip_logo.png' width='450'>
...
<div Style="bottom: 1pt solid red;background-color:white;text-align:center;">
<script language="JavaScript" type="text/javascript">
<!--
...
<center>
<em style='font-size:9pt;'>Telling van de deelnemers aan OnTip toernooien. Een doublet inschrijving telt als 2, een triplet inschrijving telt als 3, etc.<br>
	De gegevens worden bijgewerkt als een toernooi is gespeeld en verwerkt in het archief.</em>
</center>
</body>
</html>
