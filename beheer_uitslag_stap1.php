...
$toernooi_naam ='Visbak hussel';

 $qry     = mysqli_query($con,"SELECT *  From toernooi_uitslag`where Toernooi_naam ='".$toernooi_naam."'  order by Naam ")     or die(' Fout in select toernooi uitslag');  		
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
    <a style='font-family:FredokaOne;font-size:2.2vh;' class="navbar-brand pb-2 mr-2" href="<?php echo $pageName;?>"><img src='images/logo_2006.png'  width="35" border='0'> Melden uitslag Visbak toernooi</a>
 </nav>
  
<div class= 'container'   >
  <BR>
      <FORM class="needs-validation" novalidate  action='beheer_uitslag_stap2.php' autocomplete="off" ame= 'myForm' method='post' target="_top">	 
 
 
  <div class='card'>
  <div class ='card card-header'>
  <h5>Lijst uitslagen Visbak toernooi</h5>
  </div>
...
<thead>
  <tr>
  <th class  ='text-center border-right' colspan = 3></th>
  ...
  <th class  ='text-right border-right'>#</th>
    <th class  ='text-right border-right'>Del</th>
