...
/// bereken sms tegoed vanaf laatste saldo update
 ...
 //echo "SELECT count(*) as Aantal From sms_confirmations where Vereniging  = '".$vereniging."' and Laatst > '". $datum_sms_saldo_update."'  ";
  ...
  $qry2        = mysql_query("SELECT count(*) as Aantal From sms_confirmations where Vereniging  = '".$vereniging."' and Laatst > '". $datum_sms_saldo_update."'  ")     or die(' Fout in select sms gebruikt');  
 $result2     = mysql_fetch_array( $qry2 );
 $sms_aantal  = $result2['Aantal'];

 // Bereken totale lengte berichten > 160
 
 $qry3        = mysql_query("SELECT count(*) as Aantal_lange_berichten From sms_confirmations where Vereniging  = '".$vereniging."' and Laatst > '". $datum_sms_saldo_update."' and Lengte_bericht > 160 ")     or die(' Fout in select sms gebruikt');  
 ...
 $qry4        = mysql_query("SELECT count(*) as Aantal_lange_berichten From sms_confirmations where Vereniging  = '".$vereniging."' and Laatst > '". $datum_sms_saldo_update."' and Lengte_bericht > 320 ")     or die(' Fout in select sms gebruikt');  
 $result4     = mysql_fetch_array( $qry4 );
 ...
 $qry5        = mysql_query("SELECT count(*) as Aantal_lange_berichten From sms_confirmations where Vereniging  = '".$vereniging."' and Laatst > '". $datum_sms_saldo_update."' and Lengte_bericht > 480 ")     or die(' Fout in select sms gebruikt');  
 $result5     = mysql_fetch_array( $qry5 );
