...
<table   width=70%> 
 <tr>
		<td style='font-family:cursive; font-size: 14pt;color:green;'><h3>Beheer IDEAL betalingen <img src = '../ontip/images/ideal.bmp' width='60'></h3></td>
		<td style='font-family:verdana; font-size: 10pt;color:green;text-align:right;'><a href='lijst_excel_export_ideal_transacties.php?toernooi=<?php echo $toernooi; ?>' target ='_self'>Export transacties naar excel <img src = '../ontip/images/icon_excel.png' width='35'></a></td>
 </tr>
</table>
<br>
<FORM action='delete_ideal_betalingen.php' method='post' name='myForm'>
...
<tr>
		<th>Nr.</th>
		<th style='color:red;text-align:center;'>X</th>
		<th>Naam speler 1</th>
		<th>Email</th>
...
?>
  <tr>
	 <td><?php echo $i;                         ?></td>
	 <td><input type='checkbox' name='Bevestigen[]' value ='<?php echo $row['Id'];     ; ?>'  unchecked></td>
...
<input type = 'button' value ='Annuleren' onclick= "location.replace('beheer_ideal_transacties.php?toernooi=<?php echo $toernooi; ?>')">
</FORM>
<br>
