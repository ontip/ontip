...
<script language="javascript">
 document.title = "OnTip Print score formulieren";
</script> 
<?php
...
$html .= "<tr><td Style='font-family:verdana;font-size:13pt;'>Naam captain     : </td><td>".$row['Team_naam1']."</td></tr>";
$html .= "<tr><td Style='font-family:verdana;font-size:13pt;'>Vereniging       : </td><td>".$row['Team_vereniging1']."</td></tr>";
} else { 
$html .= "<br><tr><td Style='font-family:verdana;font-size:13pt;'>Naam captain   : </td><td>________________________________________________________________</td></tr>"; 
$html .= "<tr><td Style='font-family:verdana;font-size:13pt;'>Vereniging     : </td><td>________________________________________________________________</td></tr>";
 } 
$html .="</table>";
