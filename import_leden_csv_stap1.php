...
<span style='text-align:right;vertical-align:text-top;font-size:9pt;'><a href='index.php'>Terug naar Hoofdmenu</a></span><br>
</td>
</tr>
</table>

<div style='padding:10pt;font-size:20pt;color:green;'><br>Import spelerslijst eigen vereniging <img src="../ontip/images/icon_import.png" width=50 border =0 ></div>
<?php
...
?>
<script language="javascript">
 document.title = "OnTip Import ledenlijst - <?php echo  $vereniging; ?>";
</script>
<?php
...
?>
<form action="import_leden_csv_stap2.php" method="POST" enctype="multipart/form-data">
...
if ($handle = @opendir($dir)) 
{
    while (false !== ($file = @readdir($handle))) { 
        ...
        //echo $file. "-".  $ext. "<br>";
         ...
         if (strlen($file) > 3  and strpos($not_copy,$file) == false  and strtoupper($ext) == 'CSV' and substr($file,0,20) == 'licensies_vereniging'  ) {
...
<br>
<div style='font-size:10pt;color:black;' >* Het bestand <b>licensies_vereniging.csv</b> wordt gebruikt voor de selecties van leden in het inschrijfformulier (alleen voor beheerders).</div>
