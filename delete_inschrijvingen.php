...
$sql      = mysqli_query($con,"SELECT * FROM namen WHERE  IP_adres_md5 = '".md5($ip)."' and  Vereniging_id = ".$vereniging_id." and Aangelogd ='J'  ") or die(' Fout in select mail from namen') ;
$result   = mysqli_fetch_array( $sql );
$user     = $result['Naam'];
$email    = $result['Email'];
