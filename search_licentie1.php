...
/*  search_licentie.php   (c) Erik Hendrikx
    ...
    4 jan 2017 bij enkele inschrijving wordr 'undefined' ingevuld bij telefoon en email
...
// bij selectie user eigen vereniging vanuit selectie lijst
if (isset($_POST['user_select']) ){
	?><script language="javascript">
		window.location.replace('Inschrijfform.php?gevonden&user_select=Yes&toernooi=<?php echo $toernooi;?>');
</script>
	<?php
...
if (isset($_POST['simpel'])  or $simpel == 'J'  ){
	...
	?><script language="javascript">
		window.location.replace('Inschrijfform.php?simpel&gevonden&toernooi=<?php echo $toernooi;?>');
</script>
	<?php
...
?><script language="javascript">
		window.location.replace('Inschrijfform.php?gevonden&toernooi=<?php echo $toernooi;?>');
</script>
<?php
ob_end_flush();
?>