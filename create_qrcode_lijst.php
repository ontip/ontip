...
// Dit programma maakt een tekst QRCode voor het openen van de deelnemers lijst
//
...
<h3 style='padding:1pt;font-size:20pt;color:green;'>QRC Deelnemerslijst '<?php echo $toernooi_voluit; ?>' 
<?php
...
$lijst_link = $url_redirect."lijst_inschrijf_kort.html?toernooi=".$toernooi;
$lijst_link = str_replace('https:','http:', $lijst_link);

$qrc_link  = $prog_url."/images/qrc/qrcl_".$toernooi.".png";
$qrc_file  = "images/qrc/qrcl_".$toernooi.".png";
...
?>
<span style='font-size:10pt;color:black;padding:15pt;'>Door deze code met uw smartphone of tablet te scannen *(via QR Code lezer App) kunt u de deelnemerslijst van het toernooi direct openen. De code afbeelding kunt u via de rechtermuisknop (Afbeelding opslaan als..) kopieren om deze vervolgens op website of flyer te gebruiken.
