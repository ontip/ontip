...
$reply_to = 'erik.hendrikx@gmail.com'; 
...
$bericht .= "<td style= 'font-family:verdana;font-size:14pt;color:blue;'>OnTip Mail</b></td></tr>" . "\r\n";
...
$bericht .= "<tr><td  width=200  >Naam</td><td>"   .  $Naam_contactpersoon     ."</td></tr>".  "\r\n";

$bericht .= "</table>"   . "\r\n";

$bericht .= "<h4><u>Bericht</u></h4>".   "\r\n";
...
mail($reply_to, $subject, $bericht, $headers);
