...
echo "<th style='". $th_style.";'>Status inschrijving x</th>";
  ...
  if ($meerdaags_toernooi_jn =='J'){
       ...
       $toernooi_datum = $datum;
        ...
        echo "<th style='". $th_style.";font-size:8pt;'>".$_datum."</th>";        		    
       ...
       if ($meerdaags_toernooi_jn =='X'){
         ...
         $sql      = mysql_query("SELECT * from toernooi_datums_cyclus  where  Vereniging_id = ". $vereniging_id." and Toernooi ='".$toernooi."'   order by Datum" )     ; 
         	...
         	while($row = mysql_fetch_array( $sql )) { 		
	               ...
	               echo "<th style='". $th_style.";font-size:8pt;'>".$_datum."</th>";
 //        		     echo strftime('%a %e %B', mktime(0, 0, 0, $maand , $dag, $jaar) )."</th>";
...
if ($soort_inschrijving =='single' or $inschrijf_methode =='single'  ){
 ...
 //  if ($licentie_jn =='J'){
 //   echo "<td style='". $td_style.";'>". $row['Licentie1'] ."</td>" ;
 //  }
...
// echo "<td style='". $td_style_w.";'>".$row['Extra']."</td>";
...
echo "<td style='". $td_style_w.";'>".$row['Extra_invulveld']."</td>";
 ...
 //   meerdaags
    // toernooi cyclus
       ...
       //		    echo "x". $_datum." y". $deelname.":".strpos($deelname,$_datum);
