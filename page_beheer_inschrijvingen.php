...
<div style='background-color:<?php echo $indexpagina_achtergrond_kleur; ?>;color:black;width:1200pt;border:2pt solid black;height:2000pt; -moz-border-radius-topleft: 10px;
   -webkit-border-top-left-radius: 10px;
...
<br>
	...
	<div style='width:95%;background-color:white;text-align:left;border:3pt inset;'>
		
		<blockquote>
	<iframe src= 'beheer_inschrijvingen.php?toernooi=<?php echo $toernooi; ?>'  width =100%  height = 1900   scrolling="auto" frameborder="0" ></iframe>
  </blockquote>
