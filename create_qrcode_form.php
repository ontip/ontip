...
<h3 style='padding:1pt;font-size:20pt;color:green;'>QRC Inschrijfformulier mobiel'<?php echo $toernooi_voluit; ?>' 
...
$url = substr($prog_url,3);
 ...
 // de ontip link 
$form_link = $url_redirect."inschrijf_form_smal.html?simpel&mobiel&toernooi=".$toernooi;
