...
<?php
 ...
 //// SQL Queries
$qry      = mysqli_query($con,"SELECT * from inschrijf Where Toernooi = '".$toernooi."' and Vereniging = '".$vereniging."' and Status in ('RE0', 'RE1','RE4') order by Inschrijving  ASC" )    or die(mysqli_error());  
