...
// per datum aanpassen
$sql_cyclus      = mysqli_query($con,"SELECT * from toernooi_datums_cyclus  where  Vereniging_id = ". $vereniging_id." and Toernooi ='".$toernooi."' order by Datum" )     ; 
	
	while($row_cyclus = mysqli_fetch_array( $sql_cyclus )) { 		


		     $datum_cyclus = $row_cyclus['Datum'];
                      
         $qry2      = mysqli_query($con,"SELECT count(*) as Aantal  from inschrijf where  Vereniging_id = ". $vereniging_id." and Toernooi ='".$toernooi."' 
