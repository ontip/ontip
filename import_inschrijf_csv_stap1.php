...
<div style='padding:10pt;font-size:20pt;color:green;'><br>Import inschrijvingen via Excel csv bestand <img src="../ontip/images/import_ext.png" width=65 border =0 ></div>
...
?>
<form action="import_inschrijf_csv_stap2.php" method="POST" enctype="multipart/form-data">
...
<div style='text-align:left;color:black;font-size:10pt;font-family:arial;'>
   ...
   Hieronder (zie stap 1) staat een link naar een template (= voorbeeld) csv bestand. Klik op deze link en sla dit bestand op op uw PC in csv formaat.<br> 
  ...
  <br><br>
	...
	<legend style='left-padding:5pt;color:darkgreen;font-size:14px;font-family:Arial;'>Stap 1. CSV template tbv inschrijvingen</legend>
	
	<table width=95% border = 0 >
	<tr>
<td width=55%  style='text-align:left;color:blue;font-size:10pt;font-family:arial;'>
<img src='../ontip/images/icon_excel.jpg' border = 0 width =22  >	<a href = '../ontip/csv/template_inschrijven.csv' > Klik hier om het template bestand op te halen.</a></td>
	<td style='text-align:right;vertical-align:text-top;color:black;font-size:10pt'>Aanmaak datum en tijd template : 
	<?php
	$dir    =  $prog_url.'/csv';
	$bestand = $dir ."/template_inschrijven.csv";	
	echo date ("d F Y H:i:s.", filemtime($bestand));	
	?>	
</td>
</tr>
</table>
...
<table width=95% border = 0 >
	<tr>
<td width=55%  style='text-align:left;color:blue;font-size:10pt;font-family:arial;'><img src='../ontip/images/icon_excel.jpg' border = 0 width =22  >Selecteer een csv bestand met inschrijvingen voor importeren :  </td>
