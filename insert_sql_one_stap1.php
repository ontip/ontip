...
$sql        = "SELECT Id ,Vereniging,Toernooi from config group by Toernooi order by Toernooi";
//echo $sql;
...
<form method = 'post' action='insert_sql_one_stap2.php'>
...
<div Style='font-family:comic sans ms,sans-serif; color:yellow;size:12pt;'>Invoer commando pedr toernooi</div><br/><br/>
...
<tr><td width='250'STYLE ='background-color:#990000;color:orange;'><label>Doel</label></th></tr><tr><td></td>
	...
	<?php
		...
		echo "<tr><td></td><td STYLE ='background-color:#990000;color:white;font-size:9pt;'><input type ='checkbox'  name ='destination[]' value ='".$row['Id']."'>".$row['Toernooi']."</td></tr>";
