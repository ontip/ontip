...
<div class= 'container'   >
 ...
 <div class= 'card w-100'>
  ...
  <div class= 'card card-header'>
   <h4 ><i class="fa fa-calendar" aria-hidden="true"></i> Beheer datums voor Toernooi Cyclus "<?php echo $toernooi_voluit;?>"</h4>
    ...
    <div class= 'card card-body'>
       <br>
       <span style='color:black;font-size:1.4vh;font-family:arial;'>Een toernooi cyclus bestaat uit een aantal toernooien (max 10). In dit scherm kan je datums (max 10) koppelen aan dit toernooi om een cyclus aan te maken. De eerste datum is gelijk aan de opgegeven datum voor het toernooi.<br>
  ...
  <br><div style='font-weight:bold;font-size=1.4vh;' >Door een vinkje te zetten in het lege vierkant in de eerste kolom, kan je een datum verwijderen.<br>
