...
<body BACKGROUND="../boulamis_toernooi/images/ontip_grijs.jpg" width =40 bgproperties=fixed >
<br>
<form method = 'post' action='verwerk_aanlog_hussel.php' target="_top">
<?php
include('mysql.php');	
/* Set locale to Dutch */
...
<tr><td rowspan = 4 style='background-color:white;vertical-align:middle;padding:5pt;text-align:center;'><img src =  'http://www.boulamis.nl/boulamis_toernooi/images/OnTip_banner_klein.png' width = 75</td>
...
<tr><td rowspan =5 style='background-color:white;vertical-align:middle;padding:5pt;'><img src =  'http://www.boulamis.nl/boulamis_toernooi/images/OnTip_banner_klein.png' width = 75</td>
...
<tr><th width='150'STYLE ='color:green;font-size:10pt;text-align:left;padding-left:10pt;background-color:white;'><label>Wachtwoord  </label></th><td STYLE ='background-color:white;color:green;'><label><input type='password'     name='Wachtwoord'  size=21/></label></td></tr>
<tr>
