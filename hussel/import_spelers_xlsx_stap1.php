...
<div style='text-align:left;color:black;font-size:10pt;font-family:arial;'>Met behulp van deze functie kan je een excel (xlsx) bestand met spelersnamen importeren in de spelerslijst van de OnTip hussel.
		<br>De eerste 2 regels van het bestand zijn kop regels die niet geimporteerd worden.Vanaf regel 3 de spelersgegevens : Nr, Naam of Namen. Gebruik geen lege regels tussendoor.<br> Upload nu dit bestand naar de server. Direct worden de  gegevens uit het bestand geimporteeerd in een database.<br>
...
?>
<form action="import_spelers_xlsx_stap2.php" method="POST" enctype="multipart/form-data">
