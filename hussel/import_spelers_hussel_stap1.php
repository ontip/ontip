...
<div style='text-align:left;color:black;font-size:10pt;font-family:arial;'>Met behulp van deze functie kan je een excel (csv) bestand met spelersnamen importeren direct in de Hussel van de OnTip hussel. Geef eventueel de datum van gebruik op.
		<br>De eerste regel van het bestand is een header regel.Vanaf regel 2 de spelersgegevens : Nr; Naam  (puntkomma ertussen). Gebruik geen lege regels tussendoor.<br> Upload nu dit csv bestand naar de server. Direct worden de  gegevens uit het  bestand geimporteeerd in een database..</div>
<br>
...
?>
<!--import_spelers_hussel_stap2-->
<form action="import_spelers_hussel_stap2.php" method="POST" enctype="multipart/form-data">
...
<table width=75% border = 0>
	<tr>
<td width = 45% style='text-align:left;color:blue;font-size:10pt;font-family:arial;'>Selecteer het bestand (CSV) voor upload (klik op Browse/Bladeren..):  </td>
...
<fieldset style='border:1px solid red>;width:65%;padding:15pt;'>
	...
	<legend style='left-padding:5pt;color:black;font-size:14px;font-family:Arial;'>CSV bestanden op het systeem</legend>
...
if ($handle = @opendir($dir)) 
{
    while (false !== ($file = @readdir($handle))) { 
        ...
        $ext ='';
         ...
         if (strlen($file) > 3    and (strtoupper($ext) == 'CSV' )) {
