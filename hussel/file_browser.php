...
<h2>Upload schemas </h2>

<br>
	<br>
	

<div style='text-align:left;color:black;font-size:10pt;font-family:arial;'>Met behulp van deze functie kan je een excel (csv) bestand met schema's openen t.b.v de Hussel.
<br>
...
<table width=75% border = 0>
	<tr>
<td width = 45% style='text-align:left;color:blue;font-size:10pt;font-family:arial;'>Selecteer het bestand voor upload (klik op Browse/Bladeren..):  </td>
...
<fieldset style='border:1px solid red>;width:65%;padding:15pt;'>
	...
	<legend style='left-padding:5pt;color:black;font-size:14px;font-family:Arial;'>XLS bestanden op het systeem</legend>
...
if ($handle = @opendir($dir)) 
{
    while (false !== ($file = @readdir($handle))) { 
        ...
        $ext ='';
         ...
         if (strlen($file) > 3    and (strtoupper($ext) == 'XLS' )) {
...
<br>
<br>
<div style='font-size:10pt;color:blue;' >Klik op de bestandsnaam om de inhoud te bekijken en/ of te bewaren.Bestand wordt eerst naar je PC gehaald. Kan even duren.</div>
