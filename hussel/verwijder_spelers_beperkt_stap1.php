...
<div style='text-align:left;color:black;font-size:11pt;font-family: Comic sans, sans-serif, Verdana'>Met behulp van deze functie kan je de deelnemers die aangevinkt zijn in de kolom Beperkt verwijderen uit de Hussel.
	Deze spelers hebben aangegeven maar een beperkt aantal rondes te spelen. 
<br>
<br>
...
<form action='verwijder_spelers_beperkt_stap2.php' method='post'>
	<blockquote>
<table width=50%  border =1 cellpadding=0 cellspacing =0>
	...
	$i=1;
		...
		$qry  = mysql_query("SELECT * From hussel_score where Vereniging_id = ".$vereniging_id ." and Datum = '".$datum."'  and Beperkt = 'J'  ")     or die(' Fout in select');  
