...
<div style='text-align:left;color:black;font-size:10pt;font-family:arial;'>Klik eerst op de bovenstaande link naar de NJBB toernooi kalender. Open de kalender en sla deze op als CSV bestand.
		<br>Upload nu dit csv bestand naar de server. Direct worden de toernooi gegevens uit het bestand geimporteeerd in een database. Voor OnTip toernooien worden een aantal gegevens toegevoegd.</div>
<br>
...
?>
<form action="import_spelers_stap2.php" method="POST" enctype="multipart/form-data">
    ...
    while (false !== ($file = @readdir($handle))) { 
        ...
        $ext ='';
         ...
         if (strlen($file) > 3    and (strtoupper($ext) == 'CSV' )) {
            ...
            ?>
            <tr>
            <td width = 50% style='font-size:12pt;color:blue;' ><img src="../boulamis_toernooi/images/icon_excel.gif" width=32>&nbsp<a href ="<?php echo $bestand ?>" target ='_blank'><?php echo $file; ?></a>
