...
if ($source_file == ''){
	...
	<script type="text/javascript">
		alert("Geen bestand geselecteerd via Bladeren/browse !") 
   			window.location.replace('import_spelers_stap1.php');
</script>
<?php
}
...
if ($naam !=''){
$sql            = mysql_query("SELECT count(*) as Aantal  From  hussel_spelers where Vereniging_id = ".$vereniging_id." and Naam ='".$naam."'   " );
