...
<div style='text-align:left;color:black;font-size:10pt;font-family:arial;'>Met behulp van deze functie kan je een excel (csv) bestand met spelersnamen importeren in de spelerslijst van de OnTip hussel.
		<br>De eerste regel;van het bestand is een header regel.Vanaf regel 2 de spelersgegevens : Nr, Naam. Gebruik geen lege regels tussendoor.<br> Upload nu dit csv bestand naar de server. Direct worden de  gegevens uit het bestand geimporteeerd in een database..</div>
<br>
