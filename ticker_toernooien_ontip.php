...
if (isset($_GET['mouseovercolor'])) {
  $mouseovercolor=$_GET['mouseovercolor'];
} else {
	$mouseovercolor=red;
}
...
// Hieronder verander je berichten. je kunt er net zoveel toevoegen als je wilt, gewoon doornummeren. max 15
var text=new Array()
...
?>
text[0]="De komende <?php echo $limit; ?>  OnTip toernooien waarvoor men kan inschrijven. Klik op het toernooi om te openen ."
textlink[0]=""
texttarget[0]="_blank"
<?php

$qry  = mysqli_query($con,"SELECT distinct Vereniging,Toernooi,Waarde From config where  Variabele= 'datum'  
     and Toernooi !='erik_test_toernooi' and Waarde >= '".$today."' order by Waarde limit ".$limit." ")     or die(' Fout in select ');  
...
text[<?php echo $i;?>]="<?php echo $datum.": ".$vereniging."-".$toernooi_voluit."  *    ";?>"

// verander hieronder de url voor ieder bericht

textlink[<?php echo $i;?>]="<?php echo $prog_url; ?>Inschrijfform.php?toernooi=<?php echo $toernooi; ?>'"

// verander hier de target voor iedere link
// je kunt kiezen uit "_blank", "_self", "_top", "_parent"

texttarget[<?php echo $i;?>]="_blank"
<?php
$i++;
}// end while
?>
...
// letter kleur
var textfontcoloraa="<?php echo $textcolor; ?>"
var textfontcolorbb="<?php echo $textcolor; ?>"

// kleur bij mouse-over
var textfontcolorrollover="<?php echo $mouseovercolor; ?>"

// tekst grootte
var textfontsize=8

// achtergrondkleur
var textbgcolor="<?php echo $backgroundcolor; ?>"
...
var textbordercolor="<?php echo $backgroundcolor; ?>"
