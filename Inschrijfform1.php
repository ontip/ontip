...
# 24feb2019         1.0.5           E. Hendrikx 
# Symptom:   		None.
# Problem:     	    None.
# Fix:              None.
# Feature:          Bij simpele  weergave parameter 'smal' meegegeven aan link email_notificatie
# Reference: 
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($aant_splrs  >= ( $max_splrs + $aantal_reserves ) and $aantal_reserves > 0 and $meerdaags_toernooi_jn !='X' ){
   ...
   if ($aant_splrs  >= $max_splrs and $aantal_reserves == 0  and $meerdaags_toernooi_jn !='X'){
	...
	/*   
      ...
      //21 jun 2019  bij simpele weergave parameter toevoegen voor onderdrukken kop tekst in email notificatie      
	     if  (!isset($_GET['simpel'])){  

	   	  echo "<a href ='toevoegen_email_notificatie_stap1.php?toernooi=".$toernooi."&email_notificatie' target='_self'>Klik hier voor aanmelden Email notificatie</a></center>";
		   } else {
	   	  echo "<a href ='toevoegen_email_notificatie_stap1.php?toernooi=".$toernooi."&email_notificatie&smal' target='_self'>Klik hier voor aanmelden Email notificatie</a></center>";
	    }	  
