...
/*  Programma       : Prepare_ideal_betaling.php
    ...
    Aangepast       : december 2016 ivm nieuwe API Mollie
...
$vereniging_nr = $result1['Vereniging_nr'];
...
//$eurocenten    = substr($totale_kosten,-2);
//$tot           = ($euros*100)+$eurocenten;

$totale_kosten = $totale_kosten+$ideal_opslag_kosten;
$amount        = intval($totale_kosten*100);

settype($amount, "integer");

$return_url    = "http://www.ontip.nl/".substr($prog_url,2,strlen($prog_url))."ideal_betaling_gedaan.php?toernooi=".$toernooi.""; // URL waarnaar de consument teruggestuurd wordt na de betaling
...
<blockquote>
<!--table border =1 style='border-collapse: collapse;background-color:white;padding:5pt;box-shadow: 3px 3px 3px #888888;' >
