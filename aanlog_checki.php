...
$sql      = mysqli_query($con,"SELECT Naam,Beheerder , Toernooi FROM namen WHERE  IP_adres = '".$ip."' and  Vereniging_id = ".$vereniging_id." and Aangelogd ='J'  ") or die(' Fout in select ip check');  
...
if ($count > 0){
  ...
  $toernooi = $result['Toernooi'];
	...
	$sql1      = mysqli_query($con,"SELECT Laatst FROM namen WHERE  IP_adres = '".$ip."'  and  Vereniging_id = ".$vereniging_id." and Aangelogd ='J'  ") or die(' Fout in select ip');  
