...
<div class= 'container'   >
 ...
 <div class= 'card w-100'>
  ...
  <div class= 'card card-header'>
   <h4 >Uitleg menu Overig</h4>
   </div>
 
    <div class= 'card card-body'>
       <br>
       <span style='color:black;font-size:1.6 vh;font-family:arial;'>Onder deze menu optie vind je alle links die niet onder een van de andere menus geplaatst konden worden.<br>	
