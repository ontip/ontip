...
<h1> OnTip toernooi kalender - <?php echo $vereniging;?></h1>
...
$today =date('Y-m-d');
$i=0;	
	$qry       = mysqli_query($con,"SELECT * From config  where Vereniging_id =".$vereniging_id." group by Toernooi  order by Toernooi")     or die(' Fout in select meerdaags');  
